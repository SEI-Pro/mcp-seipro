...
async def capturar_tela(
    ...
    *,
    ...
    url_validada = client._validar_mesma_origem(url)  # noqa: SLF001 — mesmo uso privado que os testes de RFC 0020
    ...
    cookies = _httpx_cookies_to_playwright(client._http.cookies)  # noqa: SLF001
