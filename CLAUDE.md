...
132 tools cobrindo processos, documentos, tramitação, assinatura, blocos, marcadores, acompanhamento, credenciamento, modelos e mais.
...
Tools principais — lista parcial das 132:
...
- `src/todos/server.py` — FastMCP server com 132 tools + helpers (`_resolver_documento`, `_resolver_processo`)
...
- Todos os 132 tools funcionam em qualquer SEI 4.0+ sem mod-wssei (web-only)
