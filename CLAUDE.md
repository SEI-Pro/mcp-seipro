...
130 tools cobrindo processos, documentos, tramitação, assinatura, blocos, marcadores, acompanhamento, credenciamento, modelos e mais.
...
Tools principais — lista parcial das 129:
...
- `src/todos/server.py` — FastMCP server com 130 tools + helpers (`_resolver_documento`, `_resolver_processo`)
...
- Todos os 130 tools funcionam em qualquer SEI 4.0+ sem mod-wssei (web-only)
